...
const product = database.ref("Product");
...
firebase.auth().onAuthStateChanged((user) => {
    ...
    //   const profileNameElement = document.getElementById('item-name');
    const itemName=document.getElementById('item-name');
  
    const profilePictureElement = document.getElementById('photo'); // Assuming you have an image element for displaying the profile picture
  ...
  profileForm.addEventListener("submit", async (e) => {
    ...
    const newitem = itemName.value;
    const newdescription = description.value;
    const newunitname=unitname.value;
    const newunitprice=unitprice.value;
    const newquan=Quantity.value;
